...
* Slack out the [Deep Learning Installation Guide Folder](../../14-Deep-Learning/Supplemental/Deep_Learning_Installation_Guide). Tell students to complete the installation and verify it with a TA before the end of the next class. Students will need this installed before the next unit. 
...
* Be aware that this lesson uses version 1 of Amazon Lex. Since there is no compatibility between version 1 and version 2 of Amazon Lex, you won't be able to follow the same activities in class if you switch to the Amazon Lex V2 console. To learn more about the differences between version 1 and version 2, please read [the Lex V2 FAQ page](https://aws.amazon.com/lex/faqs/#Lex_V2) at the Amazon Lex documentation.
...
* **Step 4:** If this is the first time you use Amazon Lex, you will see the following page to get started with your first bot.
   ...
   * Be sure to click on **"Return to the V1 console"** on the left column at the bottom of the options.
