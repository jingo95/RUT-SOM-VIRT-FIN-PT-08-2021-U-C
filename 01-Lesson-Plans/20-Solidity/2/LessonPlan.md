...
* [Unsolved - JointSavings_stu_v1.sol](Activities/06-Stu_Implement_Ether_functions/Unsolved/JointSavings_stu_v1.sol)

* [Solved - JointSavings_stu_v1.sol](Activities/06-Stu_Implement_Ether_functions/Solved/JointSavings_stu_v1.sol)
...
* [JointSavings_stu_v1.sol](Activities/06-Stu_Implement_Ether_functions/Solved/JointSavings_stu_v1.sol)
...
In this activity, students will add an `if` statement to their `JointSavings` contracts that checks `if` the recipient address matches either of the account owner addresses.
...
* [JointSavings_stu_v2.sol](Activities/08-Stu_If_Else/Unsolved/JointSavings_stu_v2.sol)
...
* [JointSavings_stu_v2.sol](Activities/08-Stu_If_Else/Solved/JointSavings_stu_v2.sol)
...
* [Unsolved - JointSavings_ins_v1.sol](Activities/09-Ins_Restricting_Withdraw_With_Require/Solved/JointSavings_ins_v1.sol)
...
* [JointSavings_ins_v2.sol](Activities/10-Ins_Deploying_Contracts_in_Remix/Solved/JointSavings_ins_v2.sol)
 ...
 * Navigate to [Remix](http://remix.ethereum.org/) in your browser and open the `JointSavings_ins_v2.sol` contract.
