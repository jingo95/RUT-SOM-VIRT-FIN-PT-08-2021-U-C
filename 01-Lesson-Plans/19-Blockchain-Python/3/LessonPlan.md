...
* Ensure that you have properly installed the hd-wallet-derive PHP CLI tool at least once before class. Refer students to the install guide located [here](https://github.com/coding-boot-camp/FinTech-Lesson-Plans/blob/master/01-Lesson-Plans/19-Blockchain-Python/Supplemental/HD_Wallet_Derive_Install_Guide.md).
...
In this activity, you will lead a code along leveraging the `hd-wallet-derive` command-line tool to generate addresses using the same BIP44 scheme as the online tool.

At this point, everyone should have successfully installed the `hd-wallet-derive` tool on their systems. If necessary, refer to the install guide located [here](https://github.com/coding-boot-camp/FinTech-Lesson-Plans/blob/master/01-Lesson-Plans/19-Blockchain-Python/Supplemental/HD_Wallet_Derive_Install_Guide.md).

Begin the code along by having everyone `cd ..` into the directory containing the `hd-wallet-derive` folder.
...
![hardware wallet](Images/usb-hardware-wallet.png)
