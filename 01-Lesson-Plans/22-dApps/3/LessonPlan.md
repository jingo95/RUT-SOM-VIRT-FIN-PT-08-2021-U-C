...
- This token URI can be a real URI or URL to a certificate file on the internet. But for now, we can send just a string of text to this function. Later, we’ll replace this with a real URI that can use decentralized file storage.
