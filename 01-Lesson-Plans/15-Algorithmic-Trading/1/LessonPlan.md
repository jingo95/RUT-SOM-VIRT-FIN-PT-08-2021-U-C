...
* Once the data is ready, we continue by coding the trading algorithm. We loop through the rows using the `iterrows` Pandas function by following the the conditions defined for this algorithm.
