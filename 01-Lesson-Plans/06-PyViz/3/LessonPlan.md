...
* In preparation for next week's unit on SQL, slack out the [PgAdmin and PostgreSQL installation guides](../../07-SQL/Supplemental/InstallationGuides) to your class.  Have students complete the installation prior to next class. 
